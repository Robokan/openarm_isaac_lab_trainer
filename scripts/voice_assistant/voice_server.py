...
Return ONLY the JSON object, no other text."""
    ...
    CHAT_PROMPT = """You are JAX, an AI assistant for Spark Pack's robotics lab. You help operators control OpenArm robots through voice commands.

Your personality:
- Professional but friendly
- Concise (keep responses under 2-3 sentences for voice)
