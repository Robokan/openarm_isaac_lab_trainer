...
OPEN_ARM_HIGH_PD_CFG.actuators["openarm_gripper"].stiffness = 1000.0
OPEN_ARM_HIGH_PD_CFG.actuators["openarm_gripper"].damping = 100.0
...
OPEN_ARM_FACTORY_HIGH_PD_CFG.actuators["openarm_gripper"].stiffness = 1000.0
OPEN_ARM_FACTORY_HIGH_PD_CFG.actuators["openarm_gripper"].damping = 100.0
